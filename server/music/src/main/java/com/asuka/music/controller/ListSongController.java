...
public class ListSongController {
    ...
    * */
    ...
    public Object listSongOfAlbumId(HttpServletRequest request){
        String songListId = request.getParameter("songListId");
        return listSongService.listSongOfAlbumId(Integer.parseInt(songListId));
    }
    /*
    * 删除歌单歌曲内容
    * */
    ...
    public Object delete(HttpServletRequest request){
        String songId =request.getParameter("songId").trim();
        String songListId = request.getParameter("songListId").trim();
        boolean flag = listSongService.deleteByTwo(Integer.parseInt(songId),Integer.parseInt(songListId));
        return flag;
    }
}
